...
def setup_logger(year: int) -> logging.Logger:
    ...
    log_file = f"{log_dir}/syllabus_list_master_{timestamp}.log"

    logger = logging.getLogger(f"syllabus_list_master_{year}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        print("使用方法: python syllabus_list_master.py [年度]")
        sys.exit(1)
